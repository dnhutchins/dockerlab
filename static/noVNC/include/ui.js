...
(function () {
    ...
    UI = {
        ...
        xvpShutdown: function() {
            window.location.assign("/endsession/"+$D('noVNC_path').value.split("/")[1]);
            //UI.rfb.xvpShutdown();
        },

        xvpReboot: function() {
            window.location.assign("/reboot/"+$D('noVNC_path').value.split("/")[1]);
            //UI.rfb.xvpReboot();
        },

        xvpReset: function() {
            window.location.assign("/reset/"+$D('noVNC_path').value.split("/")[1]);
            //UI.rfb.xvpReset();
        },
